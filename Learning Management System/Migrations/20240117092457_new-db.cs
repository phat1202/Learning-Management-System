        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryImageCover = table.Column<string>(type: "longtext", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageCover = table.Column<string>(type: "longtext", nullable: true),
                    CategoryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemSelected = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    CartId = table.Column<string>(type: "varchar(255)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CommentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    StudentComment = table.Column<string>(type: "longtext", nullable: true),
                    UserId = table.Column<string>(type: "varchar(255)", nullable: true),
                    LessonId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentLessons", x => x.CommentId);
                    table.ForeignKey(
                        name: "FK_CommentLessons_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "LessonId");
                    table.ForeignKey(
                        name: "FK_CommentLessons_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                })
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "CategoryId", "CategoryImageCover", "CategoryName" },
                values: new object[,]
                {
                    { 1, null, "Web Developement" },
                    { 2, null, "Marketing" },
                    { 3, null, "SEO" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentLessons_LessonId",
                table: "CommentLessons",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentLessons_UserId",
                table: "CommentLessons",
                column: "UserId");
